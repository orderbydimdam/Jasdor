...
function track(eventName, params = {}){
  ...
  }catch(e){ /* diem aja, jangan sampe ganggu UX */ }
}
...
const MENUS = {
  coffee: [
    ...
    {name:"Kopi Kenangan Mantan",normal:21000,disc:15000,upsize:19000,emo:"☕",img:"Kopi Kenangan Mantan.webp",signature:true},
    {name:"Creamy Aren Latte",normal:24000,disc:17000,upsize:22000,emo:"☕",img:"Creamy Aren Latte.webp",signature:true},
    {name:"Americano",normal:19000,disc:14000,upsize:18000,emo:"☕",img:"Americano.webp",signature:true},
    ...
    // ── REGULAR ──
    {name:"OG Aren Speculoos Latte",normal:23000,disc:16000,upsize:21000,emo:"☕",img:"OG Aren Speculoos Latte.webp"},
    {name:"Dua Shot OG Aren",normal:27000,disc:18000,upsize:22000,emo:"☕",img:"Dua  Shot  OG  Aren.webp"},
    {name:"Mocha Caramel",normal:28000,disc:19000,upsize:23000,emo:"☕",img:"Mocha Caramel.webp"},
    {name:"Toffee Nut Latte",normal:21000,disc:15000,upsize:19000,emo:"☕",img:"Toffee Nut Latte.webp"},
    {name:"Toffee Nut Aren Latte",normal:23000,disc:16000,upsize:20000,emo:"☕",img:"Toffee Nut Aren Latte.webp"},
    {name:"Toffee Nut Oat Latte",normal:24000,disc:17000,upsize:21000,emo:"☕",img:"Toffee Nut Oat Latte.webp"},
    {name:"Pistachio Aren Latte",normal:21000,disc:15000,upsize:19000,emo:"☕",img:"Pistachio Aren Latte.webp"},
    {name:"Cafe Malt Latte",normal:25000,disc:17000,upsize:21000,emo:"☕",img:"Cafe Malt Latte.webp"},
    {name:"Caramel Latte",normal:28000,disc:19000,upsize:23500,emo:"☕",img:"Caramel Latte.webp"},
    {name:"Creamy Caramel Latte",normal:28000,disc:19000,upsize:22500,emo:"☕",img:"Creamy Caramel Latte.webp",isNew:true},
    {name:"Dua Shot Iced Shaken",normal:30000,disc:20000,upsize:26000,emo:"☕",img:"Dua Shot Iced Shaken.webp"},
    {name:"Hazelnut Latte",normal:28000,disc:19000,upsize:23500,emo:"☕",img:"Hazelnut Latte.webp"},
    {name:"Kopi Susu Black Aren",normal:23000,disc:16000,upsize:21000,emo:"☕",img:"Kopi Susu Black Aren.webp"},
    {name:"Matcha Espresso",normal:28000,disc:19000,upsize:23000,emo:"🍵",img:"Matcha Espresso.webp"},
    {name:"Mocha Latte",normal:30000,disc:20000,upsize:24000,emo:"☕",img:"Mocha Latte.webp"},
    {name:"Vanilla Latte",normal:28000,disc:19000,upsize:23000,emo:"☕",img:"Vanilla Latte.webp"},
    {name:"Avocado Coffee",normal:30000,disc:20000,upsize:26000,emo:"🥑",img:"Avocado Coffee.webp"},
    {name:"Butterscotch Aren Latte",normal:22000,disc:16000,upsize:20000,emo:"☕",img:"Butterscotch Aren Latte.webp"},
    {name:"Butterscotch Sea Salt",normal:27000,disc:18000,upsize:22500,emo:"☕",img:"Butterscotch Sea Salt.webp"},
    {name:"Cappuccino",normal:24000,disc:17000,upsize:21000,emo:"☕",img:"Cappuccino.webp"},
    {name:"Latte",normal:24000,disc:17000,upsize:21000,emo:"☕",img:"Latte.webp"},
    {name:"Thai Tea Coffee",normal:27000,disc:18000,upsize:null,emo:"🧋",img:"Thai Tea Coffee.webp",onlyLarge:true,isNew:true},
    {name:"Blueberry Americano",normal:21000,disc:15000,upsize:19000,emo:"☕",img:"Bluebeery_Americano.webp",isNew:true},
  ],
  noncoffee: [
    // ── BEST SELLER (signature) ──
    {name:"Milo Dinosaurus",normal:25000,disc:17000,upsize:21000,emo:"🥛",img:"Milo Dinosaurus.webp",signature:true},
    {name:"Raspberry Hibiscus",normal:22000,disc:16000,upsize:20000,emo:"🌺",img:"Raspberry Hibiscus.webp",signature:true},
    ...
    {name:"Og Thai Tea",normal:21000,disc:15000,upsize:19000,emo:"🧋",img:"Og Thai Tea.webp",isNew:true},
    {name:"Thai Tea Loaded",normal:29000,disc:20000,upsize:null,emo:"🧋",img:"Thai Tea Loaded.webp",onlyLarge:true,isNew:true},
    {name:"Thai Tea Aren",normal:26000,disc:18000,upsize:null,emo:"🧋",img:"Thai Tea Aren.webp",onlyLarge:true,isNew:true},
    // ── REGULAR ──
    {name:"OG Aren Milky Speculoos",normal:25000,disc:17000,upsize:21000,emo:"🥛",img:"OG Aren Milky Speculoos.webp"},
    {name:"Choco Caramel",normal:21000,disc:15000,upsize:19000,emo:"🍫",img:"Choco Caramel.webp"},
    {name:"Toffee Nut Choco Macchiato",normal:24000,disc:17000,upsize:null,emo:"🍫",img:"Toffee Nut Choco Macchiato.webp"},
    {name:"Butterscotch Sea Salt (NC)",normal:24000,disc:17000,upsize:null,emo:"🥛",img:"Butterscotch Sea Salt (NC).webp"},
    {name:"Milk Oreo Crumble",normal:28000,disc:19000,upsize:null,emo:"🍪",img:"Milk Oreo Crumble.webp"},
    {name:"Fresh Lemonade",normal:19000,disc:14000,upsize:null,emo:"🍋",img:"Fresh Lemonade.webp",onlyLarge:true},
    {name:"Hazelnut Choco Milk Tea",normal:24000,disc:17000,upsize:21000,emo:"🧋",img:"Hazelnut Choco Milk Tea.webp"},
    {name:"Avocado Caramel",normal:30000,disc:20000,upsize:26000,emo:"🥑",img:"Avocado Caramel.webp"},
    {name:"Avocado Milk",normal:26000,disc:18000,upsize:24000,emo:"🥑",img:"Avocado Milk.webp"},
    {name:"Caramel Dutch Choco",normal:30000,disc:20000,upsize:26000,emo:"🍫",img:"Caramel Dutch Choco.webp"},
    {name:"Dutch Chocolate",normal:28000,disc:19000,upsize:25000,emo:"🍫",img:"Dutch Chocolate.webp"},
    {name:"Hazelnut Dutch Choco",normal:30000,disc:20000,upsize:26000,emo:"🍫",img:"Hazelnut Dutch Choco.webp"},
    {name:"Lemon Black Tea",normal:19000,disc:14000,upsize:18000,emo:"🍋",img:"Lemon Black Tea.webp"},
    {name:"Kenangan Milk Tea",normal:23000,disc:16000,upsize:20000,emo:"🧋",img:"Kenangan Milk Tea.webp"},
    {name:"Oreo Shake",normal:28000,disc:19000,upsize:23500,emo:"🍪",img:"Oreo Shake.webp"},
    {name:"Susu Grass Jelly",normal:26000,disc:18000,upsize:22000,emo:"🥛",img:"Susu Grass Jelly.webp"},
  ],
  oatside: [
    {name:"Oatside Kopi Kenangan",normal:24000,disc:17000,upsize:21500,emo:"🥛",img:"Oatside Kopi Kenangan.webp"},
    {name:"Oatside Latte",normal:27000,disc:18000,upsize:25000,emo:"🥛",img:"Oatside Latte.webp"},
    {name:"Oatsdie Matcha Latte",normal:27000,disc:18000,upsize:22000,emo:"🍵",img:"Oatsdie Matcha Latte.webp"},
  ],
  frappe: [
    {name:"Choco Caramel Frappe",normal:30000,disc:20000,upsize:25000,emo:"🧊",img:"Choco Caramel Frappe.webp"},
    {name:"Tiramisu Frappe",normal:30000,disc:20000,upsize:25000,emo:"🧊",img:"Tiramisu Frappe.webp",signature:true},
    {name:"Butterscotch Kenangan Frappe",normal:32000,disc:21000,upsize:27000,emo:"🧊",img:"Butterscotch Kenangan Frappe.webp"},
    {name:"Matcha Kenangan Frappe",normal:34000,disc:23000,upsize:29000,emo:"🧊",img:"Matcha Kenangan Frappe.webp"},
    {name:"Kopi Kenangan Mantan Frappe",normal:29000,disc:20000,upsize:25000,emo:"🧊",img:"Kopi Kenangan Mantan Frappe.webp",signature:true},
    {name:"Vanilla Kenangan Frappe",normal:27000,disc:18000,upsize:23000,emo:"🧊",img:"Vanilla Kenangan Frappe.webp"},
    {name:"Dutch Choco Kenangan Frappe",normal:31000,disc:21000,upsize:26000,emo:"🧊",img:"Dutch Choco Kenangan Frappe.webp"},
    {name:"Blueberry Frappe",normal:25000,disc:17000,upsize:22000,emo:"🧊",img:"Bluebeery_Frappe.webp",isNew:true},
    {name:"Chocoberry Frappe",normal:29000,disc:20000,upsize:25000,emo:"🧊",img:"Chocoberry_Frappe.webp",isNew:true},
    {name:"Coffeberry Frappe",normal:27000,disc:19000,upsize:24000,emo:"🧊",img:"Coffeberry_Frappe.webp",isNew:true},
  ],
  bake: [
    {name:"Coffee Butter Bun",normal:13000,disc:11000,upsize:null,emo:"🍞",img:"Coffee Butter Bun.webp",isNew:true},
    {name:"Choco Muffin",normal:18000,disc:14000,upsize:null,emo:"🧁",img:"Choco Muffin.webp"},
    {name:"Blueberry Muffin",normal:18000,disc:14000,upsize:null,emo:"🧁",img:"Blueberry Muffin.webp"},
    {name:"Choco Mocha Swirl Toast",normal:20000,disc:15000,upsize:null,emo:"🍞",img:"Choco Mocha Swirl Toast.webp"},
    {name:"Strawberry Choux Puff",normal:15000,disc:12000,upsize:null,emo:"🍓",img:"Strawberry Choux Puff.webp"},
    {name:"Donut Tiramisu",normal:16000,disc:13000,upsize:null,emo:"🍩",img:"Donut Tiramisu.webp"},
    {name:"Danish Tiramisu",normal:22000,disc:16000,upsize:null,emo:"🥐",img:"Danish Tiramisu.webp"},
    {name:"Roti Gulung Abon",normal:20000,disc:15000,upsize:null,emo:"🍞",img:"Roti Gulung Abon.webp"},
    {name:"Roti Gulung Aren",normal:17000,disc:13000,upsize:null,emo:"🍞",img:"Roti Gulung Aren.webp"},
    {name:"Sandwich Chicken Tart",normal:24000,disc:17000,upsize:null,emo:"🥪",img:"Sandwich Chicken Tart.webp"},
    {name:"Roti Sisir Coklat",normal:16000,disc:13000,upsize:null,emo:"🍞",img:"Roti Sisir Coklat.webp"},
    {name:"Canele Aren",normal:18000,disc:14000,upsize:null,emo:"🥐",img:"Canele Aren.webp"},
    {name:"Canele Original",normal:16000,disc:13000,upsize:null,emo:"🥐",img:"Canele Original.webp"},
    {name:"Canele Toffee Nut Crumble",normal:18000,disc:14000,upsize:null,emo:"🥐",img:"Canele Toffee Nut Crumble.webp"},
    {name:"Aren Apple Pie",normal:20000,disc:15000,upsize:null,emo:"🥧",img:"Aren Apple Pie.webp"},
    {name:"Vanilla Choux Puff",normal:15000,disc:12000,upsize:null,emo:"🍮",img:"Vanilla Choux Puff.webp"},
    {name:"Chocolate Choux Puff",normal:15000,disc:12000,upsize:null,emo:"🍫",img:"Chocolate Choux Puff.webp"},
    {name:"Salt Bread Original",normal:14000,disc:12000,upsize:null,emo:"🍞",img:"Salt Bread Original.webp"},
    {name:"Salt Bread Beef and Cheese",normal:17000,disc:13000,upsize:null,emo:"🥪",img:"Salt Bread Beef and Cheese.webp"},
    {name:"Sandwich Smoked Beef & Cheese",normal:24000,disc:17000,upsize:null,emo:"🥪",img:"Sandwich Smoked Beef & Cheese.webp"},
    {name:"Roti Sisir Keju",normal:17000,disc:13000,upsize:null,emo:"🍞",img:"Roti Sisir Keju.webp"},
    {name:"Dirty Croissant Milo",normal:22000,disc:16000,upsize:null,emo:"🥐",img:"Dirty Croissant Milo.webp"},
    {name:"Croissant Abon",normal:20000,disc:15000,upsize:null,emo:"🥐",img:"Croissant Abon.webp"},
    {name:"Donut Almond",normal:16000,disc:13000,upsize:null,emo:"🍩",img:"Donut Almond.webp"},
  ],
  toast: [
    {name:"Bambang Choco Cheese",normal:19000,disc:14000,upsize:null,emo:"🍞",img:"Bambang Choco Cheese.webp"},
    {name:"Adam Ayam Toast",normal:21000,disc:15000,upsize:null,emo:"🥪",img:"Adam Ayam Toast.webp"},
  ...
  food: [
    ...
    {name:"Roti Susu Manis",normal:12000,disc:10000,upsize:null,emo:"🍞",img:"Roti Susu Manis.webp"},
    {name:"Roti Keju Manis",normal:15000,disc:12000,upsize:null,emo:"🧀",img:"Roti Keju Manis.webp"},
    {name:"Roti Srikaya",normal:17000,disc:13000,upsize:null,emo:"🍞",img:"Roti Srikaya.webp"},
    {name:"Join The Dark Side Cookie",normal:23000,disc:16000,upsize:null,emo:"🍪",img:"Join The Dark Side Cookie.webp"},
    {name:"Choco Chip Cookies",normal:16000,disc:13000,upsize:null,emo:"🍪",img:"Choco Chip Cookies.webp"},
    {name:"Friend Chip Cookie",normal:19000,disc:14000,upsize:null,emo:"🍪",img:"Friend Chip Cookie.webp"},
    {name:"Salt Bread Choco Butter",normal:13000,disc:10000,upsize:null,emo:"🍞",img:"Salt_Bread_Choco_Butter.webp",isNew:true},
    {name:"Salt Bread Sausage",normal:16000,disc:12000,upsize:null,emo:"🌭",img:"Salt_Bread_Sausage.webp",isNew:true},
  ],
};
...
function addToCartFromModal(ev){
  ...
  track('add_to_cart', {
    currency: 'IDR',
    value: price * modalState.qty,
    items: [{ item_name: item.name, quantity: modalState.qty, price: price }]
  });
...
function sendToWA(){
  ...
  track('begin_checkout', { currency: 'IDR', items_count: cart.length });
}
...
function confirmSendToWA(){
  ...
  track('generate_lead', { currency: 'IDR', value: Math.max(0, total - discount), items_count: cart.length });
...
function brandSendToWA(){
  ...
  const url = "https://wa.me/" + WA_NUMBER + "?text=" + encodeURIComponent(msg);
  window._lastWAUrl = url; // simpan untuk tombol fallback
  track('generate_lead', { currency: 'IDR', brand: data.name, type: isQuestion ? 'question' : 'order' });
